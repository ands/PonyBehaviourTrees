...
{
    class PBTTaskTreeControl<DataType> : GLGroupLayout
    {
        public readonly PBTTaskControl<DataType> TaskControl;
        public readonly List<PBTTaskTreeControl<DataType>> Subtrees = new List<PBTTaskTreeControl<DataType>>();
